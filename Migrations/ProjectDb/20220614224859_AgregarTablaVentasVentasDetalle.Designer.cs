...
namespace Proyecto_Vesa.Migrations.ProjectDb
{
    ...
    [Migration("20220614224859_AgregarTablaVentasVentasDetalle")]
    partial class AgregarTablaVentasVentasDetalle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_Vesa.Areas.Identity.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Proyecto_Vesa.Models.Venta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_Vesa.Models.VentaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_Vesa.Models.Venta", b =>
                {
                    b.HasOne("Proyecto_Vesa.Areas.Identity.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Proyecto_Vesa.Models.VentaDetalle", b =>
                {
                    b.HasOne("Proyecto_Vesa.Models.Destino", "Destino")
                        .WithMany()
                        .HasForeignKey("Key_IdProducto");

                    b.HasOne("Proyecto_Vesa.Models.Venta", "Venta")
                        .WithMany()
